...
import PopMenu from "./Mission/PopMenu";
...
import {  IntoMission,GetUserMissionList } from "../../request/api";
...
export default function Mission() {
  ...
  function join(e){
    if(e.isdelete===2 || e.timeStatus==="已结束" || e.timeStatus==="未开始" || e.status==="已满"){
      return 1;
    }else{
      return 0;
    }
              ...
              <List.Item
                actions={[
                  ...
                  <Popconfirm //弹窗确认
                    ...
                    disabled={join(item)}
                  >
                    <Button size="small" disabled={join(item)} type="primary" key="list-loadmore-more">
                      加入
                    </Button>
                  </Popconfirm>,
                ]}
